/*
Standalone script to import data into the MongoDB
Original script location: https://raw.githubusercontent.com/mdn/express-locallibrary-tutorial/main/populatedb.js
Modified the original script to reuse database connectivity and to convert to ES6 environment
*/
...
async function main() {
  try {
    ...
    console.err('Error in main:', error);
  } finally {
